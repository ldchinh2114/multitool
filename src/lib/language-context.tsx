...
const translations = {
  en: {
    ...
    hobbies: 'Hobbies',
    enterHobbies: 'Enter hobbies separated by commas',
    hobbiesExample: 'Example: Reading, Traveling, Photography, Playing guitar',
    hobbiesPreview: 'Preview:',
  ...
  vi: {
    ...
    hobbies: 'Sở thích',
    enterHobbies: 'Nhập sở thích cách nhau bằng dấu phẩy',
    hobbiesExample: 'Ví dụ: Đọc sách, Du lịch, Nhiếp ảnh, Chơi guitar',
    hobbiesPreview: 'Xem trước:',
