...
const translations = {
  en: {
    ...
    currencyDesc: 'Convert between major currencies with real-time exchange rates. Support for USD, VND, EUR, JPY, GBP, CNY, KRW, HKD, and TWD.',
    ...
    advanced: 'Advanced',
    fluent: 'Fluent',
    noLanguagesYet: 'No languages added yet. Click "Add" to add one.',
    // PDF Labels
    phoneLabel: 'Phone:',
    ...
    noDraftsDesc: 'Create your first draft to get started',
    expired: 'Expired',
  ...
  vi: {
    ...
    currencyDesc: 'Chuyển đổi giữa các loại tiền tệ chính với tỷ giá hối đoái thời gian thực. Hỗ trợ USD, VND, EUR, JPY, GBP, CNY, KRW, HKD và TWD.',
    ...
    upperIntermediate: 'Trung cao cấp',
    advanced: 'Cao cấp',
    fluent: 'Thành thạo',
    noLanguagesYet: 'Chưa có ngôn ngữ. Nhấn "Thêm" để thêm.',
    // PDF Labels
    ...
    draftTitle: 'Tiêu đề bản nháp',
    createdAt: 'Ngày tạo',
    lastModified: 'Chỉnh sửa cuối',
    expiresIn: 'Hết hạn sau',
    noDrafts: 'Chưa có bản nháp nào',
    noDraftsDesc: 'Tạo bản nháp đầu tiên của bạn',
    expired: 'Đã hết hạn',
    confirmDeleteDraft: 'Bạn có chắc muốn xóa bản nháp này không?',
    draftCreated: 'Tạo bản nháp thành công',
    draftUpdated: 'Cập nhật bản nháp thành công',
    draftDeleted: 'Xóa bản nháp thành công',
  },
};
